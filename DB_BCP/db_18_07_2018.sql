...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 18 2018 г., 14:37
...
(57, 1, 5, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Переводы', 'translations', 'fa-globe', 1, 'Статические переводы', 0, '#', '2013-11-15 03:30:00', '2016-11-25 18:00:00', 1);
...
CREATE TABLE IF NOT EXISTS `osc_logs` (
  ...
  `ip` varchar(64) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='Project logs';
...
(36, '2018-07-18 13:55:49', 1, 'Admin login: Success login.', 1, '::1');
...
(1, 0, 0, 'home', 0, 0, 0, '2018-03-31 00:00:00', '2018-07-18 14:42:50', 'Home', 'Главная', 'Головна'),
(5, 0, 0, 'contacts', 4, 0, 0, '2018-03-31 00:00:00', '2018-07-18 14:34:22', 'Contacts', 'Контакты', 'Контакти'),
...
(1, 'CHARGING \r\nGREEN FUTURE \r\nOF UKRAINE', '', '', 'si_20180419195436176.jpg', NULL, '2018-07-18 14:58:50', 'CHARGING \r\nGREEN FUTURE \r\nOF UKRAINE', '', NULL, 'CHARGING \r\nGREEN FUTURE \r\nOF UKRAINE', '', NULL),
...
(1, 'Services', 'in Ukraine\'s Renewable Energy Sector', NULL, 'si_20180413024748778.jpg', NULL, '2018-07-18 15:26:37', 'Сервисы', NULL, NULL, 'Сервiси', NULL, NULL);
...
(1, 'Our projects', 'in Ukraine\'s Renewable Energy Sector', '<p><span style=\"color: rgb(87, 86, 86); font-family: RobotoL, Tahoma; font-size: 16px; letter-spacing: 1px; background-color: rgb(255, 255, 255);\">Volterra energy group portfolio consists of projects in Solar, Wind, Small hydro, Waste-to-energy and energy storage sectors. Combined installed capacity exceeds 300 MW to be commissioned in 2018-2019.</span><br></p>', NULL, '2018-07-18 15:33:48', 'Наши проекты', NULL, '<p><span style=\"color: rgb(87, 86, 86); font-family: RobotoL, Tahoma; font-size: 16px; letter-spacing: 1px; background-color: rgb(255, 255, 255);\">Volterra energy group portfolio consists of projects in Solar, Wind, Small hydro, Waste-to-energy and energy storage sectors. Combined installed capacity exceeds 300 MW to be commissioned in 2018-2019.</span><br></p>', 'Нашi проекти', NULL, '');
...
(1, 'Solar', 'Солнце', 'Сонце', 'solar_ico.png', 0),
(2, 'Wind', 'Ветер', 'Вiтер', 'wind_ico.png', 0),
(3, 'Hydro', 'Гидро', 'Гiдро', 'gidro_ico.png', 0),
(4, 'Bio', 'Био', 'Бiо', 'bio_ico.png', 0),
(5, 'Recycle', 'Переработка', 'Переробка', 'recycle_ico.png', 0);
...
(1, 'Volterra', 'info@volterra.energy', '+38 0443346405\r\n+38 0443346407', 'Ukraine, Kiev \r\nStr. Bolshaya Vasilkovskaya, 100 \r\nBC Toronto', NULL, NULL, NULL, NULL, 50.426, 30.515, 0, 'Copyright ©2018 Volterra Energy Group. All Rights Reserved', '', '', '2018-07-18 17:32:37', 'Украина, Киев\r\nул. Большая Васильковская, 100 \r\nБЦ Торонто', 'Copy', 'Україна, Київ\r\nвул. Велика Василькiвська, 100 \r\nБЦ Торонто', NULL);
...
(1, 'Vilshanka 1', 'vilshanka-1', 3, 0, '', '', '', 0, 0, '', '', 3, '', '', '2018-07-18 16:33:44', '2018-07-18 16:33:44', NULL, '', '', '', '', NULL, NULL, NULL, NULL, NULL),
(2, 'Vilshanka 2', 'vilshanka-2', 2, 0, '', '', '', 0, 0, '', '', 3, '', '', '2018-07-18 16:33:44', '2018-07-18 16:33:44', NULL, '', '', '', '', NULL, NULL, NULL, NULL, NULL),
(3, 'Vilshanka 3', 'vilshanka-3', 1, 0, 'Specification 1', 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellat nemo mollitia quam perferendis magnam! Voluptatem enim dolorem labore, et eveniet numquam sequi saepe. Laboriosam nemo totam a pariatur exercitationem nesciunt.', 's1_proto20180426234521256.docx', 48.244, 30.876, '<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/uQRyg4i4T9o\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen></iframe>', '<iframe src=\"https://360player.io/p/BEGuwg/\" frameborder=\"0\" allowfullscreen=\"\" data-token=\"BEGuwg\"></iframe>', 3, 'Permit documentation', 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellat nemo mollitia quam perferendis magnam! Voluptatem enim dolorem labore, et eveniet numquam sequi saepe. Laboriosam nemo totam a pariatur exercitationem nesciunt.', '2018-07-18 16:33:44', '2018-07-18 16:33:44', NULL, '', '', 'Разрешительная документация', '', NULL, NULL, NULL, NULL, NULL),
(12, NULL, NULL, 0, 1, '', '', NULL, 0, 0, '', '', 9, '', '', '2018-07-18 16:21:00', '2018-07-18 16:21:00', NULL, '', '', '', '', NULL, NULL, NULL, NULL, NULL),
(13, NULL, NULL, 0, 1, '', '', NULL, 0, 0, '', '', 9, '', '', '2018-07-18 16:21:00', '2018-07-18 16:21:00', NULL, '', '', '', '', NULL, NULL, NULL, NULL, NULL),
(14, NULL, NULL, 0, 1, '', '', NULL, 0, 0, '', '', 9, '', '', '2018-07-18 16:21:00', '2018-07-18 16:21:00', NULL, '', '', '', '', NULL, NULL, NULL, NULL, NULL);
...
(10, 'contacts', 'Заголовок страницы', 'Our contacts', 'Наши контакты', 'Нашi контакти'),
...
(25, 'home', 'Секция 2 - название таба с контентом', 'Who we are', 'Кто мы', 'Хто ми'),
(26, 'home', 'Секция 2 - название таба с контентом', 'Our strategy', 'Наша стратегия', 'Наша стратегiя'),
(27, 'home', 'Секция 2 - название таба с контентом', 'Our mission', 'Наша миссия', 'Наша місія'),
(28, 'invest-relations', 'Ответ формы авторизации', 'Login is not available now. Please contact support.', 'Авторизация сейчас недоступна. Пожалуйста, обратитесь в службу поддержки.', 'Авторизацiя зараз недоступна. Будь ласка, зверніться до служби пiдтримки. '),
(29, 'all', 'Ответ формы обратной связи (name)', 'Enter correct name.', 'Укажите корректное имя.', 'Вкажiть коректне iм\'я.'),
(30, 'all', 'Ответ формы обратной связи (email)', 'Enter correct email.', 'Введите правильный email.', 'Введiть правильний email.'),
(31, 'all', 'Ответ формы обратной связи (phone)', 'Enter correct phone.', 'Введите правильный телефон.', 'Введiть правильний телефон.'),
(32, 'all', 'Ответ формы обратной связи (message)', 'Message is too short.', 'Сообщение слишком короткое.', 'Повiдомлення занадто коротке.'),
(33, 'all', 'Ответ формы обратной связи (success)', 'Message have been sent.', 'Сообщение было отправлено.', 'Повiдомлення було надiслане.'),
(34, 'modal', 'Заголовок модального окна', 'Write to us', 'Напишите нам', 'Напишiть нам'),
(35, 'modal', 'Поле формы \"Имя\"', 'Your name', 'Ваше имя', 'Ваше iм\'я'),
(36, 'modal', 'Поле формы \"Email\"', 'Email address', 'Email адрес', 'Email адреса'),
(37, 'modal', 'Поле формы \"Телефон\"', 'Phone number', 'Номер телефона', 'Номер телефону'),
(38, 'modal', 'Поле формы \"Сообщение\"', 'Message', 'Сообщение', 'Повiдомлення'),
(39, 'modal', 'Кнопка формы', 'Send', 'Отправить', 'Вiдправити');
