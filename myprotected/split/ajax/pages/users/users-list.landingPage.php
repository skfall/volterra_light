<?php 
	...
	$filter3_options = array( 
							'sort' => array( 'ID'=>'M.id', 'Name'=>'M.first_name'),
	...
	$tableColumns = array(
						  ...
						  'Пользователь'	=>	array('type'=>'text',		'field'=>'first_name',				'params'=>array( 'secondField'=>'last_name', 'separate'=>" " ) ),
						  'Группа'			=>	array('type'=>'text',		'field'=>'type_name'),
						  'Публикация'		=>	array('type'=>'block',		'field'=>'block'),

						  'Дата регистрации'=>	array('type'=>'date',		'field'=>'created', 			'params'=>array( 'format'=>'d-m-Y', 'function'=>'long') ),
