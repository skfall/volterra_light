...
class personalHelp extends BasicHelp
{
		...
		public function getQuestionItem($id)
		{
			...
			$q = "UPDATE osc_recall SET `seen` = '1' WHERE id = '$id' LIMIT 1";
			$this->rs($q);
		...
		public function getVisitsItem($id)
		{
			$query = "
				SELECT M.*
				FROM [pre]sys_appointments as M
				WHERE M.id='$id' 
				LIMIT 1
			";
			$resultMassive = $this->rs($query);
			...
			$q = "UPDATE osc_sys_appointments SET `seen` = '1' WHERE id = '$id' LIMIT 1";
			$this->rs($q);
		...
		public function getVisits($params=array(),$typeCount=false)
		{
			// Filter params
		...
		public function getCFItem($id)
		{
			$query = "
				SELECT M.*
				FROM [pre]sys_contact_form as M
				WHERE M.id='$id' 
				LIMIT 1
			";
			$resultMassive = $this->rs($query);
			...
			$q = "UPDATE osc_sys_contact_form SET `seen` = '1' WHERE id = '$id' LIMIT 1";
			$this->rs($q);
		...
		public function getEventRecall($id)
		{
			$query = "
				SELECT M.*
				FROM [pre]event_recall as M
				WHERE M.id='$id' 
				LIMIT 1
			";
			$resultMassive = $this->rs($query);
		...
		public function getEventRecalls($params=array(),$typeCount=false)
		{
			// Filter params
			...
			if(!$typeCount)
			{
				...
				$query = "
						SELECT M.*,
						(SELECT E.name FROM `osc_sys_events` AS E WHERE E.id = M.event_id LIMIT 1) as name_event 
						FROM [pre]event_recall as M
						WHERE 1 $filter_and 
						ORDER BY $sort_field $sort_vector 
						LIMIT $start,$limit";
		...
		public function getTransfer($params=array(),$typeCount=false)
		{
			// Filter params
		...
		public function getSubscriptionsItem($id)
		{
			$query = "
				SELECT M.*
				FROM [pre]subscriptions as M
				WHERE M.id='$id' 
				LIMIT 1
			";
			$resultMassive = $this->rs($query);
			...
			$q = "UPDATE osc_subscriptions SET `seen` = '1' WHERE id = '$id' LIMIT 1";
			$this->rs($q);
		...
		public function getSubscriptions($params=array(),$typeCount=false)
		{
			// Filter params
		...
		public function getBpQuestionsItem($id)
		{
			$query = "
				SELECT M.*
				FROM [pre]bp_questions as M
				WHERE M.id='$id' 
				LIMIT 1
			";
			$resultMassive = $this->rs($query);
			...
			$q = "UPDATE osc_bp_questions SET `seen` = '1' WHERE id = '$id' LIMIT 1";
			$this->rs($q);
		...
		public function getBpQuestions($params=array(),$typeCount=false)
		{
			// Filter params
		...
		public function getBpSubscriptionsItem($id)
		{
			$query = "
				SELECT M.*
				FROM [pre]bp_subscriptions as M
				WHERE M.id='$id' 
				LIMIT 1
			";
			$resultMassive = $this->rs($query);
			...
			$q = "UPDATE osc_bp_subscriptions SET `seen` = '1' WHERE id = '$id' LIMIT 1";
			$this->rs($q);
		...
		public function getBpSubscriptions($params=array(),$typeCount=false)
		{
			// Filter params
