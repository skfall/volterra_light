	...
	<div class="project_item_wrapper">
				...
				<div class="row">
					<div class="col xl8 l8 m10 s10 project_description z-depth-1">
						...
						<ul class="features">
							...
							<li style="background-image: url('{{ IMG.'area_ico.png' }}');">21 Га</li>
		...
		<div class="container details">
			...
			<div class="content_target">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam neque, reprehenderit. Illum iusto impedit consequatur quisquam eligendi ullam cumque, quaerat alias, iste, aspernatur, esse? Ab et, delectus quod hic a.</p>
			</div>
		</div>
	</div>
